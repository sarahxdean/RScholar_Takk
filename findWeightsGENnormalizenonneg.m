...
for i=1:20      
    ...
    rt = testResiduals(ts(:,1:n,1),ts(:,1:n,2),weight,ts(:,n+1,1),1);
    rl = testResiduals(data_light(:,1:n,1),data_light(:,1:n,2),weight,data_light(:,n+1,1),1);
    rh = testResiduals(data_heavy(:,1:n,1),data_heavy(:,1:n,2),weight,data_heavy(:,n+1,1),1);

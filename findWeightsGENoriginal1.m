...
function [weight,allr,allrt,allrl,allrh,allrt2,allrl2,allrh2] = findWeightsGENoriginal1(data_standard,data_light,data_heavy,array,ds_2,dl_2,dh_2,both)
...
for i=1:20    
    ...
    if nargin > 4
        if both
            r_t2 = testResiduals(ts_2(:,1:n,1),ts_2(:,1:n,2),weight,ts_2(:,n+1,1),1);
        else
